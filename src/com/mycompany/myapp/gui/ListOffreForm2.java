 ...
 * @author ASUS
 */
public class ListOffreForm2 extends  Form {
    
    Form current;
     public ListOffreForm2(Form current) {
         current = createForm();
    }
     ...
     public Form createForm() {
       ...
       Toolbar.setGlobalToolbar(true);
        ...
        tb.addMaterialCommandToSideMenu("Offre", FontImage.MATERIAL_EVENT, e -> {
...
//            
            BodyConainter.add(new Label(String.valueOf(o.getNomOffre())));
            BodyConainter.add(new Label(o.getDescriptionOffre()));
            BodyConainter.add(new Label(String.valueOf(o.getPrixOffre())));
            BodyConainter.add(new Label(String.valueOf(o.getReduction())));
            BodyConainter.add(new Label(String.valueOf(o.getDateDebutOffre())));
            BodyConainter.add(new Label(String.valueOf(o.getDateFinOffre())));
